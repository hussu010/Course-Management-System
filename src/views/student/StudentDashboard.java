...
import views.common.ResultList;
...
public class StudentDashboard {
	...
	public StudentDashboard(JFrame frame, User user) {
		...
		resultButton.setBounds(510, 20, 150, 30);
        ...
        try {
        	...
        	for (Module module : moduleList) {
            	...
            	cardPanel.setLayout(new GridLayout(4, 0));
